 ...
 *
 * $Id: PrintQueueJobDeleteRequest.swift 73952 2019-03-07 22:36:32Z gidriss $
 */
...
/**
 ...
 - SeeAlso: https://docs.miva.com/json-api/functions/printqueuejob_delete
 */
public class PrintQueueJobDeleteRequest : Request {
    ...
    /**
     ...
     - Parameters:
        - callback: The callback function with signature (PrintQueueJobDeleteResponse?, Error?).
     - Note: Overrides
     */
     public override func send(client: Optional<Client> = nil, callback: @escaping (PrintQueueJobDeleteResponse?, Error?) -> ()) throws {
        if client != nil {
            client!.send(self) { request, response, error in
                callback(response as? PrintQueueJobDeleteResponse, error)
            }
    ...
    /**
     ...
     - Note: Overrides
     */
    public override func createResponse(data : Data) throws -> PrintQueueJobDeleteResponse {
        let decoder = JSONDecoder()
        
        decoder.userInfo[Response.decoderRequestUserInfoKey]      = self
        decoder.userInfo[Response.decoderResponseDataUserInfoKey] = data
        
        return try decoder.decode(PrintQueueJobDeleteResponse.self, from: data)
    }
    ...
    override public func getResponseType() -> Response.Type {
        return PrintQueueJobDeleteResponse.self
    }

...
public class PrintQueueJobDeleteRequest : Request {
     ...
     */
     ...
     public override func send(client: Optional<BaseClient> = nil, callback: @escaping (PrintQueueJobDeleteResponse?, Error?) -> ()) throws {
    ...
    /**
     ...
     - Note: Overrides
     */
    public override func createResponse(httpResponse: URLResponse, data : Data) throws -> PrintQueueJobDeleteResponse {

...
/**
 ...
 - SeeAlso: https://docs.miva.com/json-api/functions/pricegroupexcludedcategory_update_assigned
 */
public class PriceGroupExcludedCategoryUpdateAssignedRequest : Request {
    ...
    /**
     ...
     - Parameters:
        - callback: The callback function with signature (PriceGroupExcludedCategoryUpdateAssignedResponse?, Error?).
     - Note: Overrides
     */

     public override func send(client: Optional<BaseClient> = nil, callback: @escaping (PriceGroupExcludedCategoryUpdateAssignedResponse?, Error?) -> ()) throws {
        if let client = client ?? self.client {
            client.send(self) { request, response, error in
                callback(response as? PriceGroupExcludedCategoryUpdateAssignedResponse, error)
            }
        } else {
    ...
    /**
     ...
     - Note: Overrides
     */
    public override func createResponse(httpResponse: URLResponse, data : Data) throws -> PriceGroupExcludedCategoryUpdateAssignedResponse {
        ...
        return try decoder.decode(PriceGroupExcludedCategoryUpdateAssignedResponse.self, from: data)
    }
    ...
    override public func getResponseType() -> Response.Type {
        return PriceGroupExcludedCategoryUpdateAssignedResponse.self
    }

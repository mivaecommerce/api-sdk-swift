...
public class CopyProductRulesModuleListLoadQueryRequest : ListQueryRequest {
    ...
    override var function : String {
        return "CopyProductRulesModuleList_Load_Query"
    }
    ...
    /**
     ...
     - Parameters:
        - callback: The callback function with signature (CopyProductRulesModuleListLoadQueryResponse?, Error?).
     - Note: Overrides
     */

     public override func send(client: Optional<BaseClient> = nil, callback: @escaping (CopyProductRulesModuleListLoadQueryResponse?, Error?) -> ()) throws {
        if let client = client ?? self.client {
            client.send(self) { request, response, error in
                callback(response as? CopyProductRulesModuleListLoadQueryResponse, error)
            }
        } else {
    ...
    /**
     ...
     - Note: Overrides
     */
    public override func createResponse(httpResponse: URLResponse, data : Data) throws -> CopyProductRulesModuleListLoadQueryResponse {
        ...
        return try decoder.decode(CopyProductRulesModuleListLoadQueryResponse.self, from: data)
    }
    ...
    override public func getResponseType() -> Response.Type {
        return CopyProductRulesModuleListLoadQueryResponse.self
    }

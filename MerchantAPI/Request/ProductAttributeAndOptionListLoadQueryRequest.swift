...
/**
 ...
 - SeeAlso: https://docs.miva.com/json-api/functions/productattributeandoptionlist_load_query
 */
public class ProductAttributeAndOptionListLoadQueryRequest : ListQueryRequest {
    ...
    /**
     ...
     - Parameters:
        - callback: The callback function with signature (ProductAttributeAndOptionListLoadQueryResponse?, Error?).
     - Note: Overrides
     */

     public override func send(client: Optional<BaseClient> = nil, callback: @escaping (ProductAttributeAndOptionListLoadQueryResponse?, Error?) -> ()) throws {
        if let client = client ?? self.client {
            client.send(self) { request, response, error in
                callback(response as? ProductAttributeAndOptionListLoadQueryResponse, error)
            }
        } else {
    ...
    /**
     ...
     - Note: Overrides
     */
    public override func createResponse(httpResponse: URLResponse, data : Data) throws -> ProductAttributeAndOptionListLoadQueryResponse {
        ...
        return try decoder.decode(ProductAttributeAndOptionListLoadQueryResponse.self, from: data)
    }
    ...
    override public func getResponseType() -> Response.Type {
        return ProductAttributeAndOptionListLoadQueryResponse.self
    }

...
/**
 ...
 - SeeAlso: https://docs.miva.com/json-api/functions/attribute_update
 */
public class AttributeUpdateRequest : Request {
    ...
    public init(client: Optional<BaseClient> = nil, productAttribute: Optional<ProductAttribute> = nil) {
        ...
        if let productAttribute = productAttribute {
            ...
            self.editAttribute = productAttribute.code
            self.code = productAttribute.code
            self.prompt = productAttribute.prompt
            self.type = productAttribute.type
            self.image = productAttribute.image
            self.price = productAttribute.price
            self.cost = productAttribute.cost
            self.weight = productAttribute.weight
            self.required = productAttribute.isRequired
            self.inventory = productAttribute.inventory
        }
    }
    ...
    public override func encode(to encoder: Encoder) throws {
        ...
        try container.encodeIfPresent(self.editAttribute, forKey: .editAttribute)
    ...
    /**
     ...
     - Parameters:
        - callback: The callback function with signature (AttributeUpdateResponse?, Error?).
     - Note: Overrides
     */

     public override func send(client: Optional<BaseClient> = nil, callback: @escaping (AttributeUpdateResponse?, Error?) -> ()) throws {
        if let client = client ?? self.client {
            client.send(self) { request, response, error in
                callback(response as? AttributeUpdateResponse, error)
            }
        } else {
    ...
    /**
     ...
     - Note: Overrides
     */
    public override func createResponse(httpResponse: URLResponse, data : Data) throws -> AttributeUpdateResponse {
        ...
        return try decoder.decode(AttributeUpdateResponse.self, from: data)
    }
    ...
    override public func getResponseType() -> Response.Type {
        return AttributeUpdateResponse.self
    }

 ...
 *
 * $Id: OrderPaymentRefundRequest.swift 73952 2019-03-07 22:36:32Z gidriss $
 */
...
public class OrderPaymentRefundRequest : Request {
    ...
    /**
     ...
     - Note: Overrides
     */
     public override func send(client: Optional<Client> = nil, callback: @escaping (OrderPaymentRefundResponse?, Error?) -> ()) throws {
        if client != nil {
    ...
    /**
     ...
     - Note: Overrides
     */
    public override func createResponse(data : Data) throws -> OrderPaymentRefundResponse {

...
/**
 ...
 - SeeAlso: https://docs.miva.com/json-api/functions/pricegroupexcludedproductlist_load_query
 */
public class PriceGroupExcludedProductListLoadQueryRequest : ListQueryRequest {
    ...
    /**
     ...
     - Parameters:
        - callback: The callback function with signature (PriceGroupExcludedProductListLoadQueryResponse?, Error?).
     - Note: Overrides
     */

     public override func send(client: Optional<BaseClient> = nil, callback: @escaping (PriceGroupExcludedProductListLoadQueryResponse?, Error?) -> ()) throws {
        if let client = client ?? self.client {
            client.send(self) { request, response, error in
                callback(response as? PriceGroupExcludedProductListLoadQueryResponse, error)
            }
        } else {
    ...
    /**
     ...
     - Note: Overrides
     */
    public override func createResponse(httpResponse: URLResponse, data : Data) throws -> PriceGroupExcludedProductListLoadQueryResponse {
        ...
        return try decoder.decode(PriceGroupExcludedProductListLoadQueryResponse.self, from: data)
    }
    ...
    override public func getResponseType() -> Response.Type {
        return PriceGroupExcludedProductListLoadQueryResponse.self
    }

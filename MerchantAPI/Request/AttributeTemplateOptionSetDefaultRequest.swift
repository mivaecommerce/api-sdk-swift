...
/**
 ...
 - SeeAlso: https://docs.miva.com/json-api/functions/attributetemplateoption_set_default
 */
public class AttributeTemplateOptionSetDefaultRequest : Request {
    ...
    var attributeTemplateOptionDefault : Optional<Bool> = nil
    ...
    private enum CodingKeys: String, CodingKey {
        ...
        case attributeTemplateOptionDefault = "AttributeTemplateOption_Default"
    }
    ...
    public override func encode(to encoder: Encoder) throws {
        ...
        try container.encodeIfPresent(self.attributeTemplateOptionDefault, forKey: .attributeTemplateOptionDefault)
    ...
    /**
     ...
     - Parameters:
        - callback: The callback function with signature (AttributeTemplateOptionSetDefaultResponse?, Error?).
     - Note: Overrides
     */

     public override func send(client: Optional<BaseClient> = nil, callback: @escaping (AttributeTemplateOptionSetDefaultResponse?, Error?) -> ()) throws {
        if let client = client ?? self.client {
            client.send(self) { request, response, error in
                callback(response as? AttributeTemplateOptionSetDefaultResponse, error)
            }
        } else {
    ...
    /**
     ...
     - Note: Overrides
     */
    public override func createResponse(httpResponse: URLResponse, data : Data) throws -> AttributeTemplateOptionSetDefaultResponse {
        ...
        return try decoder.decode(AttributeTemplateOptionSetDefaultResponse.self, from: data)
    }
    ...
    override public func getResponseType() -> Response.Type {
        return AttributeTemplateOptionSetDefaultResponse.self
    }
     ...
     */
    public func getAttributeTemplateOptionDefault() -> Optional<Bool> {
        return self.attributeTemplateOptionDefault
    }
     ...
     */
    @discardableResult
    public func setAttributeTemplateOptionDefault(_ value: Optional<Bool>) -> Self {
        self.attributeTemplateOptionDefault = value
        return self
    }
}

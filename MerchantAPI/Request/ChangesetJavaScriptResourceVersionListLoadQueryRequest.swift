...
public class ChangesetJavaScriptResourceVersionListLoadQueryRequest : ListQueryRequest {
    ...
    /**
     ...
     - Parameters:
        - callback: The callback function with signature (ChangesetJavaScriptResourceVersionListLoadQueryResponse?, Error?).
     - Note: Overrides
     */

     public override func send(client: Optional<BaseClient> = nil, callback: @escaping (ChangesetJavaScriptResourceVersionListLoadQueryResponse?, Error?) -> ()) throws {
        if let client = client ?? self.client {
            client.send(self) { request, response, error in
                callback(response as? ChangesetJavaScriptResourceVersionListLoadQueryResponse, error)
            }
        } else {
    ...
    /**
     ...
     - Note: Overrides
     */
    public override func createResponse(httpResponse: URLResponse, data : Data) throws -> ChangesetJavaScriptResourceVersionListLoadQueryResponse {
        ...
        return try decoder.decode(ChangesetJavaScriptResourceVersionListLoadQueryResponse.self, from: data)
    }
    ...
    override public func getResponseType() -> Response.Type {
        return ChangesetJavaScriptResourceVersionListLoadQueryResponse.self
    }

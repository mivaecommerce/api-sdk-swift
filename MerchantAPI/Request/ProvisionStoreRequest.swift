...
public class ProvisionStoreRequest : Request {
     ...
     */
     ...
     public override func send(client: Optional<BaseClient> = nil, callback: @escaping (ProvisionStoreResponse?, Error?) -> ()) throws {
    ...
    /**
     ...
     - Note: Overrides
     */
    public override func createResponse(httpResponse: URLResponse, data : Data) throws -> ProvisionStoreResponse {

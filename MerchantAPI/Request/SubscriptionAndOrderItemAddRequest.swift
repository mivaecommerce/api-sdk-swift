...
public class SubscriptionAndOrderItemAddRequest : Request {
    ...
    /**
     ...
     - Parameters:
        - callback: The callback function with signature (SubscriptionAndOrderItemAddResponse?, Error?).
     - Note: Overrides
     */

     public override func send(client: Optional<BaseClient> = nil, callback: @escaping (SubscriptionAndOrderItemAddResponse?, Error?) -> ()) throws {
        if let client = client ?? self.client {
            client.send(self) { request, response, error in
                callback(response as? SubscriptionAndOrderItemAddResponse, error)
            }
        } else {
    ...
    /**
     ...
     - Note: Overrides
     */
    public override func createResponse(httpResponse: URLResponse, data : Data) throws -> SubscriptionAndOrderItemAddResponse {
        ...
        return try decoder.decode(SubscriptionAndOrderItemAddResponse.self, from: data)
    }
    ...
    override public func getResponseType() -> Response.Type {
        return SubscriptionAndOrderItemAddResponse.self
    }

...
public class ProductVariantGenerateDelimiterRequest : Request {
    ...
    /**
     ...
     - Parameters:
        - callback: The callback function with signature (ProductVariantGenerateDelimiterResponse?, Error?).
     - Note: Overrides
     */

     public override func send(client: Optional<BaseClient> = nil, callback: @escaping (ProductVariantGenerateDelimiterResponse?, Error?) -> ()) throws {
        if let client = client ?? self.client {
            client.send(self) { request, response, error in
                callback(response as? ProductVariantGenerateDelimiterResponse, error)
            }
        } else {
    ...
    /**
     ...
     - Note: Overrides
     */
    public override func createResponse(httpResponse: URLResponse, data : Data) throws -> ProductVariantGenerateDelimiterResponse {
        ...
        return try decoder.decode(ProductVariantGenerateDelimiterResponse.self, from: data)
    }
    ...
    override public func getResponseType() -> Response.Type {
        return ProductVariantGenerateDelimiterResponse.self
    }

...
/**
 ...
 - SeeAlso: https://docs.miva.com/json-api/functions/productvariant_generate
 */
public class ProductVariantGenerateRequest : Request {
    ...
    /**
     ...
     - Parameters:
        - callback: The callback function with signature (ProductVariantGenerateResponse?, Error?).
     - Note: Overrides
     */

     public override func send(client: Optional<BaseClient> = nil, callback: @escaping (ProductVariantGenerateResponse?, Error?) -> ()) throws {
        if let client = client ?? self.client {
            client.send(self) { request, response, error in
                callback(response as? ProductVariantGenerateResponse, error)
            }
        } else {
    ...
    /**
     ...
     - Note: Overrides
     */
    public override func createResponse(httpResponse: URLResponse, data : Data) throws -> ProductVariantGenerateResponse {
        ...
        return try decoder.decode(ProductVariantGenerateResponse.self, from: data)
    }
    ...
    override public func getResponseType() -> Response.Type {
        return ProductVariantGenerateResponse.self
    }

...
/**
 ...
 - SeeAlso: https://docs.miva.com/json-api/functions/customeraddresslist_delete
 */
public class CustomerAddressListDeleteRequest : Request {
    ...
    private enum CodingKeys: String, CodingKey {
        ...
        case customerAddressIds = "CustomerAddress_IDs"
    }
    ...
    public override func encode(to encoder: Encoder) throws {
        ...
        try container.encodeIfPresent(self.customerAddressIds, forKey: .customerAddressIds)
    ...
    /**
     ...
     - Parameters:
        - callback: The callback function with signature (CustomerAddressListDeleteResponse?, Error?).
     - Note: Overrides
     */

     public override func send(client: Optional<BaseClient> = nil, callback: @escaping (CustomerAddressListDeleteResponse?, Error?) -> ()) throws {
        if let client = client ?? self.client {
            client.send(self) { request, response, error in
                callback(response as? CustomerAddressListDeleteResponse, error)
            }
        } else {
    ...
    /**
     ...
     - Note: Overrides
     */
    public override func createResponse(httpResponse: URLResponse, data : Data) throws -> CustomerAddressListDeleteResponse {
        ...
        return try decoder.decode(CustomerAddressListDeleteResponse.self, from: data)
    }
    ...
    override public func getResponseType() -> Response.Type {
        return CustomerAddressListDeleteResponse.self
    }
     ...
     */
    @discardableResult
    public func addCustomerAddress_ID(_ customerAddressId : Int) -> Self {
        self.customerAddressIds.append(customerAddressId);
        return self
    }
     ...
     */
    @discardableResult
    public func addCustomerAddress(_ customerAddress: CustomerAddress) -> Self {
        if customerAddress.id > 0 {
            self.customerAddressIds.append(customerAddress.id)
        }

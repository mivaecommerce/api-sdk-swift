...
public class OrderItemListCreateReturnRequest : Request {
    ...
    /**
     ...
     - Parameters:
        - callback: The callback function with signature (OrderItemListCreateReturnResponse?, Error?).
     - Note: Overrides
     */

     public override func send(client: Optional<BaseClient> = nil, callback: @escaping (OrderItemListCreateReturnResponse?, Error?) -> ()) throws {
        if let client = client ?? self.client {
            client.send(self) { request, response, error in
                callback(response as? OrderItemListCreateReturnResponse, error)
            }
        } else {
    ...
    /**
     ...
     - Note: Overrides
     */
    public override func createResponse(httpResponse: URLResponse, data : Data) throws -> OrderItemListCreateReturnResponse {
        ...
        return try decoder.decode(OrderItemListCreateReturnResponse.self, from: data)
    }
    ...
    override public func getResponseType() -> Response.Type {
        return OrderItemListCreateReturnResponse.self
    }

...
public class BranchTemplateVersionListLoadQueryRequest : ListQueryRequest {
    ...
    /**
     ...
     - Parameters:
        - callback: The callback function with signature (BranchTemplateVersionListLoadQueryResponse?, Error?).
     - Note: Overrides
     */

     public override func send(client: Optional<BaseClient> = nil, callback: @escaping (BranchTemplateVersionListLoadQueryResponse?, Error?) -> ()) throws {
        if let client = client ?? self.client {
            client.send(self) { request, response, error in
                callback(response as? BranchTemplateVersionListLoadQueryResponse, error)
            }
        } else {
    ...
    /**
     ...
     - Note: Overrides
     */
    public override func createResponse(httpResponse: URLResponse, data : Data) throws -> BranchTemplateVersionListLoadQueryResponse {
        ...
        return try decoder.decode(BranchTemplateVersionListLoadQueryResponse.self, from: data)
    }
    ...
    override public func getResponseType() -> Response.Type {
        return BranchTemplateVersionListLoadQueryResponse.self
    }

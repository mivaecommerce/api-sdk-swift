...
public class OrderPaymentCaptureRequest : Request {
     ...
     */
     ...
     public override func send(client: Optional<BaseClient> = nil, callback: @escaping (OrderPaymentCaptureResponse?, Error?) -> ()) throws {
    ...
    /**
     ...
     - Note: Overrides
     */
    public override func createResponse(httpResponse: URLResponse, data : Data) throws -> OrderPaymentCaptureResponse {

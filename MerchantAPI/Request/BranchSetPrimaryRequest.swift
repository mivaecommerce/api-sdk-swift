...
/**
 ...
 - SeeAlso: https://docs.miva.com/json-api/functions/branch_setprimary
 */
public class BranchSetPrimaryRequest : Request {
    ...
    /**
     ...
     - Parameters:
        - callback: The callback function with signature (BranchSetPrimaryResponse?, Error?).
     - Note: Overrides
     */

     public override func send(client: Optional<BaseClient> = nil, callback: @escaping (BranchSetPrimaryResponse?, Error?) -> ()) throws {
        if let client = client ?? self.client {
            client.send(self) { request, response, error in
                callback(response as? BranchSetPrimaryResponse, error)
            }
        } else {
    ...
    /**
     ...
     - Note: Overrides
     */
    public override func createResponse(httpResponse: URLResponse, data : Data) throws -> BranchSetPrimaryResponse {
        ...
        return try decoder.decode(BranchSetPrimaryResponse.self, from: data)
    }
    ...
    override public func getResponseType() -> Response.Type {
        return BranchSetPrimaryResponse.self
    }

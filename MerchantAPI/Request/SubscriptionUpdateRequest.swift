...
public class SubscriptionUpdateRequest : Request {
    ...
    /**
     ...
     - Parameters:
        ...
        - subscription: An optional Subscription instance.
     */
    public init(client: Optional<BaseClient> = nil, subscription: Optional<Subscription> = nil) {
    ...
    /**
     ...
     - Parameters:
        - callback: The callback function with signature (SubscriptionUpdateResponse?, Error?).
     - Note: Overrides
     */

     public override func send(client: Optional<BaseClient> = nil, callback: @escaping (SubscriptionUpdateResponse?, Error?) -> ()) throws {
        if let client = client ?? self.client {
            client.send(self) { request, response, error in
                callback(response as? SubscriptionUpdateResponse, error)
            }
        } else {
    ...
    /**
     ...
     - Note: Overrides
     */
    public override func createResponse(httpResponse: URLResponse, data : Data) throws -> SubscriptionUpdateResponse {
    ...
    override public func getResponseType() -> Response.Type {
        return SubscriptionUpdateResponse.self
    }

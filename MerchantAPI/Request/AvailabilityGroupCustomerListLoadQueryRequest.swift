...
/**
 ...
 - SeeAlso: https://docs.miva.com/json-api/functions/availabilitygroupcustomerlist_load_query
 */
public class AvailabilityGroupCustomerListLoadQueryRequest : ListQueryRequest {
    /**
    ...
    /**
     ...
     - Parameters:
        - callback: The callback function with signature (AvailabilityGroupCustomerListLoadQueryResponse?, Error?).
     - Note: Overrides
     */

     public override func send(client: Optional<BaseClient> = nil, callback: @escaping (AvailabilityGroupCustomerListLoadQueryResponse?, Error?) -> ()) throws {
        if let client = client ?? self.client {
            client.send(self) { request, response, error in
                callback(response as? AvailabilityGroupCustomerListLoadQueryResponse, error)
            }
        } else {
    ...
    /**
     ...
     - Note: Overrides
     */
    public override func createResponse(httpResponse: URLResponse, data : Data) throws -> AvailabilityGroupCustomerListLoadQueryResponse {
        ...
        return try decoder.decode(AvailabilityGroupCustomerListLoadQueryResponse.self, from: data)
    }
    ...
    override public func getResponseType() -> Response.Type {
        return AvailabilityGroupCustomerListLoadQueryResponse.self
    }

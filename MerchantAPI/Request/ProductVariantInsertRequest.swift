...
public class ProductVariantInsertRequest : Request {
    ...
    /**
     ...
     - Parameters:
        - callback: The callback function with signature (ProductVariantInsertResponse?, Error?).
     - Note: Overrides
     */

     public override func send(client: Optional<BaseClient> = nil, callback: @escaping (ProductVariantInsertResponse?, Error?) -> ()) throws {
        if let client = client ?? self.client {
            client.send(self) { request, response, error in
                callback(response as? ProductVariantInsertResponse, error)
            }
        } else {
    ...
    /**
     ...
     - Note: Overrides
     */
    public override func createResponse(httpResponse: URLResponse, data : Data) throws -> ProductVariantInsertResponse {
        ...
        return try decoder.decode(ProductVariantInsertResponse.self, from: data)
    }
    ...
    override public func getResponseType() -> Response.Type {
        return ProductVariantInsertResponse.self
    }

...
public class CouponListLoadQueryRequest : ListQueryRequest {
     ...
     */
     ...
     public override func send(client: Optional<BaseClient> = nil, callback: @escaping (CouponListLoadQueryResponse?, Error?) -> ()) throws {
    ...
    /**
     ...
     - Note: Overrides
     */
    public override func createResponse(httpResponse: URLResponse, data : Data) throws -> CouponListLoadQueryResponse {

...
/**
 ...
 - SeeAlso: https://docs.miva.com/json-api/functions/attribute_delete
 */
public class AttributeDeleteRequest : Request {
    ...
    /**
     ...
     - Parameters:
        - callback: The callback function with signature (AttributeDeleteResponse?, Error?).
     - Note: Overrides
     */

     public override func send(client: Optional<BaseClient> = nil, callback: @escaping (AttributeDeleteResponse?, Error?) -> ()) throws {
        if let client = client ?? self.client {
            client.send(self) { request, response, error in
                callback(response as? AttributeDeleteResponse, error)
            }
        } else {
    ...
    /**
     ...
     - Note: Overrides
     */
    public override func createResponse(httpResponse: URLResponse, data : Data) throws -> AttributeDeleteResponse {
        ...
        return try decoder.decode(AttributeDeleteResponse.self, from: data)
    }
    ...
    override public func getResponseType() -> Response.Type {
        return AttributeDeleteResponse.self
    }

...
/**
 ...
 - SeeAlso: https://docs.miva.com/json-api/functions/attributetemplateoption_update
 */
public class AttributeTemplateOptionUpdateRequest : Request {
    ...
    /**
     ...
     - Parameters:
        - callback: The callback function with signature (AttributeTemplateOptionUpdateResponse?, Error?).
     - Note: Overrides
     */

     public override func send(client: Optional<BaseClient> = nil, callback: @escaping (AttributeTemplateOptionUpdateResponse?, Error?) -> ()) throws {
        if let client = client ?? self.client {
            client.send(self) { request, response, error in
                callback(response as? AttributeTemplateOptionUpdateResponse, error)
            }
        } else {
    ...
    /**
     ...
     - Note: Overrides
     */
    public override func createResponse(httpResponse: URLResponse, data : Data) throws -> AttributeTemplateOptionUpdateResponse {
        ...
        return try decoder.decode(AttributeTemplateOptionUpdateResponse.self, from: data)
    }
    ...
    override public func getResponseType() -> Response.Type {
        return AttributeTemplateOptionUpdateResponse.self
    }

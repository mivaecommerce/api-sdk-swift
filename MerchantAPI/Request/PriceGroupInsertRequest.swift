...
public class PriceGroupInsertRequest : Request {
    ...
    public override func encode(to encoder: Encoder) throws {
        ...
        try container.encodeIfPresent(Decimal.roundForEncoding(value: self.discount, precision: 2), forKey: .discount)
        try container.encodeIfPresent(Decimal.roundForEncoding(value: self.markup, precision: 2), forKey: .markup)
        ...
        try container.encodeIfPresent(Decimal.roundForEncoding(value: self.qualifyingMinSubtotal, precision: 2), forKey: .qualifyingMinSubtotal)
        try container.encodeIfPresent(Decimal.roundForEncoding(value: self.qualifyingMaxSubtotal, precision: 2), forKey: .qualifyingMaxSubtotal)
        ...
        try container.encodeIfPresent(Decimal.roundForEncoding(value: self.qualifyingMinWeight, precision: 2), forKey: .qualifyingMinWeight)
        try container.encodeIfPresent(Decimal.roundForEncoding(value: self.qualifyingMaxWeight, precision: 2), forKey: .qualifyingMaxWeight)
        try container.encodeIfPresent(Decimal.roundForEncoding(value: self.basketMinSubtotal, precision: 2), forKey: .basketMinSubtotal)
        try container.encodeIfPresent(Decimal.roundForEncoding(value: self.basketMaxSubtotal, precision: 2), forKey: .basketMaxSubtotal)
        ...
        try container.encodeIfPresent(Decimal.roundForEncoding(value: self.basketMinWeight, precision: 2), forKey: .basketMinWeight)
        try container.encodeIfPresent(Decimal.roundForEncoding(value: self.basketMaxWeight, precision: 2), forKey: .basketMaxWeight)

...
public class PrintQueueListLoadQueryRequest : ListQueryRequest {
     ...
     */
     ...
     public override func send(client: Optional<BaseClient> = nil, callback: @escaping (PrintQueueListLoadQueryResponse?, Error?) -> ()) throws {
    ...
    /**
     ...
     - Note: Overrides
     */
    public override func createResponse(httpResponse: URLResponse, data : Data) throws -> PrintQueueListLoadQueryResponse {

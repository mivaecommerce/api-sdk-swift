...
/**
 ...
 - SeeAlso: https://docs.miva.com/json-api/functions/copyproductrulesmodule_update_assigned
 */
public class CopyProductRulesModuleUpdateAssignedRequest : Request {
    ...
    /**
     ...
     - Parameters:
        - callback: The callback function with signature (CopyProductRulesModuleUpdateAssignedResponse?, Error?).
     - Note: Overrides
     */

     public override func send(client: Optional<BaseClient> = nil, callback: @escaping (CopyProductRulesModuleUpdateAssignedResponse?, Error?) -> ()) throws {
        if let client = client ?? self.client {
            client.send(self) { request, response, error in
                callback(response as? CopyProductRulesModuleUpdateAssignedResponse, error)
            }
        } else {
    ...
    /**
     ...
     - Note: Overrides
     */
    public override func createResponse(httpResponse: URLResponse, data : Data) throws -> CopyProductRulesModuleUpdateAssignedResponse {
        ...
        return try decoder.decode(CopyProductRulesModuleUpdateAssignedResponse.self, from: data)
    }
    ...
    override public func getResponseType() -> Response.Type {
        return CopyProductRulesModuleUpdateAssignedResponse.self
    }

...
/**
 ...
 - SeeAlso: https://docs.miva.com/json-api/functions/pageuri_update
 */
public class PageURIUpdateRequest : Request {
    ...
    /**
     ...
     - Parameters:
        - callback: The callback function with signature (PageURIUpdateResponse?, Error?).
     - Note: Overrides
     */

     public override func send(client: Optional<BaseClient> = nil, callback: @escaping (PageURIUpdateResponse?, Error?) -> ()) throws {
        if let client = client ?? self.client {
            client.send(self) { request, response, error in
                callback(response as? PageURIUpdateResponse, error)
            }
        } else {
    ...
    /**
     ...
     - Note: Overrides
     */
    public override func createResponse(httpResponse: URLResponse, data : Data) throws -> PageURIUpdateResponse {
        ...
        return try decoder.decode(PageURIUpdateResponse.self, from: data)
    }
    ...
    override public func getResponseType() -> Response.Type {
        return PageURIUpdateResponse.self
    }

...
public class ProductKitVariantCountRequest : Request {
    ...
    /**
     ...
     - Parameters:
        - callback: The callback function with signature (ProductKitVariantCountResponse?, Error?).
     - Note: Overrides
     */

     public override func send(client: Optional<BaseClient> = nil, callback: @escaping (ProductKitVariantCountResponse?, Error?) -> ()) throws {
        if let client = client ?? self.client {
            client.send(self) { request, response, error in
                callback(response as? ProductKitVariantCountResponse, error)
            }
        } else {
    ...
    /**
     ...
     - Note: Overrides
     */
    public override func createResponse(httpResponse: URLResponse, data : Data) throws -> ProductKitVariantCountResponse {
        ...
        return try decoder.decode(ProductKitVariantCountResponse.self, from: data)
    }
    ...
    override public func getResponseType() -> Response.Type {
        return ProductKitVariantCountResponse.self
    }

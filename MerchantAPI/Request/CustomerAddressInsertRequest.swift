...
public class CustomerAddressInsertRequest : Request {
    ...
    /**
     ...
     - Parameters:
        - callback: The callback function with signature (CustomerAddressInsertResponse?, Error?).
     - Note: Overrides
     */

     public override func send(client: Optional<BaseClient> = nil, callback: @escaping (CustomerAddressInsertResponse?, Error?) -> ()) throws {
        if let client = client ?? self.client {
            client.send(self) { request, response, error in
                callback(response as? CustomerAddressInsertResponse, error)
            }
        } else {
    ...
    /**
     ...
     - Note: Overrides
     */
    public override func createResponse(httpResponse: URLResponse, data : Data) throws -> CustomerAddressInsertResponse {
        ...
        return try decoder.decode(CustomerAddressInsertResponse.self, from: data)
    }
    ...
    override public func getResponseType() -> Response.Type {
        return CustomerAddressInsertResponse.self
    }

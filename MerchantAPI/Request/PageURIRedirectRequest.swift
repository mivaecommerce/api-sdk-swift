...
/**
 ...
 - SeeAlso: https://docs.miva.com/json-api/functions/pageuri_redirect
 */
public class PageURIRedirectRequest : ListQueryRequest {
    ...
    /**
     ...
     - Parameters:
        - callback: The callback function with signature (PageURIRedirectResponse?, Error?).
     - Note: Overrides
     */

     public override func send(client: Optional<BaseClient> = nil, callback: @escaping (PageURIRedirectResponse?, Error?) -> ()) throws {
        if let client = client ?? self.client {
            client.send(self) { request, response, error in
                callback(response as? PageURIRedirectResponse, error)
            }
        } else {
    ...
    /**
     ...
     - Note: Overrides
     */
    public override func createResponse(httpResponse: URLResponse, data : Data) throws -> PageURIRedirectResponse {
        ...
        return try decoder.decode(PageURIRedirectResponse.self, from: data)
    }
    ...
    override public func getResponseType() -> Response.Type {
        return PageURIRedirectResponse.self
    }

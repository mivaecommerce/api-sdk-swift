...
/**
 ...
 - SeeAlso: https://docs.miva.com/json-api/functions/feeduri_update
 */
public class FeedURIUpdateRequest : Request {
    ...
    /**
     ...
     - Parameters:
        - callback: The callback function with signature (FeedURIUpdateResponse?, Error?).
     - Note: Overrides
     */

     public override func send(client: Optional<BaseClient> = nil, callback: @escaping (FeedURIUpdateResponse?, Error?) -> ()) throws {
        if let client = client ?? self.client {
            client.send(self) { request, response, error in
                callback(response as? FeedURIUpdateResponse, error)
            }
        } else {
    ...
    /**
     ...
     - Note: Overrides
     */
    public override func createResponse(httpResponse: URLResponse, data : Data) throws -> FeedURIUpdateResponse {
        ...
        return try decoder.decode(FeedURIUpdateResponse.self, from: data)
    }
    ...
    override public func getResponseType() -> Response.Type {
        return FeedURIUpdateResponse.self
    }

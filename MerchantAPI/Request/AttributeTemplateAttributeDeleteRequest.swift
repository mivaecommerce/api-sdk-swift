...
/**
 ...
 - SeeAlso: https://docs.miva.com/json-api/functions/attributetemplateattribute_delete
 */
public class AttributeTemplateAttributeDeleteRequest : Request {
    ...
    /**
     ...
     - Parameters:
        - callback: The callback function with signature (AttributeTemplateAttributeDeleteResponse?, Error?).
     - Note: Overrides
     */

     public override func send(client: Optional<BaseClient> = nil, callback: @escaping (AttributeTemplateAttributeDeleteResponse?, Error?) -> ()) throws {
        if let client = client ?? self.client {
            client.send(self) { request, response, error in
                callback(response as? AttributeTemplateAttributeDeleteResponse, error)
            }
        } else {
    ...
    /**
     ...
     - Note: Overrides
     */
    public override func createResponse(httpResponse: URLResponse, data : Data) throws -> AttributeTemplateAttributeDeleteResponse {
        ...
        return try decoder.decode(AttributeTemplateAttributeDeleteResponse.self, from: data)
    }
    ...
    override public func getResponseType() -> Response.Type {
        return AttributeTemplateAttributeDeleteResponse.self
    }

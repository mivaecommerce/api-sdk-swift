...
/**
 ...
 - SeeAlso: https://docs.miva.com/json-api/functions/attributetemplateattribute_update
 */
public class AttributeTemplateAttributeUpdateRequest : Request {
    ...
    public init(client: Optional<BaseClient> = nil, attributeTemplateAttribute: Optional<AttributeTemplateAttribute> = nil) {
        ...
        if let attributeTemplateAttribute = attributeTemplateAttribute {
            ...
            } else if attributeTemplateAttribute.code.count > 0 {
                self.attributeTemplateAttributeCode = attributeTemplateAttribute.code
            } else if attributeTemplateAttribute.code.count > 0 {
                self.editAttributeTemplateAttribute = attributeTemplateAttribute.code
            }
        }
    }
    ...
    /**
     ...
     - Parameters:
        - callback: The callback function with signature (AttributeTemplateAttributeUpdateResponse?, Error?).
     - Note: Overrides
     */

     public override func send(client: Optional<BaseClient> = nil, callback: @escaping (AttributeTemplateAttributeUpdateResponse?, Error?) -> ()) throws {
        if let client = client ?? self.client {
            client.send(self) { request, response, error in
                callback(response as? AttributeTemplateAttributeUpdateResponse, error)
            }
        } else {
    ...
    /**
     ...
     - Note: Overrides
     */
    public override func createResponse(httpResponse: URLResponse, data : Data) throws -> AttributeTemplateAttributeUpdateResponse {
        ...
        return try decoder.decode(AttributeTemplateAttributeUpdateResponse.self, from: data)
    }
    ...
    override public func getResponseType() -> Response.Type {
        return AttributeTemplateAttributeUpdateResponse.self
    }

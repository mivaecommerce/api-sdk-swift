 ...
 */
public class PriceGroupBusinessAccountListLoadQueryRequest : ListQueryRequest {
    /**
    ...
    /**
     ...
     - Parameters:
        - callback: The callback function with signature (PriceGroupBusinessAccountListLoadQueryResponse?, Error?).
     - Note: Overrides
     */

     public override func send(client: Optional<BaseClient> = nil, callback: @escaping (PriceGroupBusinessAccountListLoadQueryResponse?, Error?) -> ()) throws {
        if let client = client ?? self.client {
            client.send(self) { request, response, error in
                callback(response as? PriceGroupBusinessAccountListLoadQueryResponse, error)
            }
        } else {
    ...
    /**
     ...
     - Note: Overrides
     */
    public override func createResponse(httpResponse: URLResponse, data : Data) throws -> PriceGroupBusinessAccountListLoadQueryResponse {
        ...
        return try decoder.decode(PriceGroupBusinessAccountListLoadQueryResponse.self, from: data)
    }
    ...
    override public func getResponseType() -> Response.Type {
        return PriceGroupBusinessAccountListLoadQueryResponse.self
    }

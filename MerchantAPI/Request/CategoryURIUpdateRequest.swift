...
/**
 ...
 - SeeAlso: https://docs.miva.com/json-api/functions/categoryuri_update
 */
public class CategoryURIUpdateRequest : Request {
    ...
    /**
     ...
     - Parameters:
        - callback: The callback function with signature (CategoryURIUpdateResponse?, Error?).
     - Note: Overrides
     */

     public override func send(client: Optional<BaseClient> = nil, callback: @escaping (CategoryURIUpdateResponse?, Error?) -> ()) throws {
        if let client = client ?? self.client {
            client.send(self) { request, response, error in
                callback(response as? CategoryURIUpdateResponse, error)
            }
        } else {
    ...
    /**
     ...
     - Note: Overrides
     */
    public override func createResponse(httpResponse: URLResponse, data : Data) throws -> CategoryURIUpdateResponse {
        ...
        return try decoder.decode(CategoryURIUpdateResponse.self, from: data)
    }
    ...
    override public func getResponseType() -> Response.Type {
        return CategoryURIUpdateResponse.self
    }

...
/**
 ...
 - SeeAlso: https://docs.miva.com/json-api/functions/changesetlist_load_query
 */
public class ChangesetListLoadQueryRequest : ListQueryRequest {
    ...
    /**
     ...
     - Parameters:
        - callback: The callback function with signature (ChangesetListLoadQueryResponse?, Error?).
     - Note: Overrides
     */

     public override func send(client: Optional<BaseClient> = nil, callback: @escaping (ChangesetListLoadQueryResponse?, Error?) -> ()) throws {
        if let client = client ?? self.client {
            client.send(self) { request, response, error in
                callback(response as? ChangesetListLoadQueryResponse, error)
            }
        } else {
    ...
    /**
     ...
     - Note: Overrides
     */
    public override func createResponse(httpResponse: URLResponse, data : Data) throws -> ChangesetListLoadQueryResponse {
        ...
        return try decoder.decode(ChangesetListLoadQueryResponse.self, from: data)
    }
    ...
    override public func getResponseType() -> Response.Type {
        return ChangesetListLoadQueryResponse.self
    }

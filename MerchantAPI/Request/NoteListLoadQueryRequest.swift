...
public class NoteListLoadQueryRequest : ListQueryRequest {
     ...
     */
     ...
     public override func send(client: Optional<BaseClient> = nil, callback: @escaping (NoteListLoadQueryResponse?, Error?) -> ()) throws {
    ...
    /**
     ...
     - Note: Overrides
     */
    public override func createResponse(httpResponse: URLResponse, data : Data) throws -> NoteListLoadQueryResponse {

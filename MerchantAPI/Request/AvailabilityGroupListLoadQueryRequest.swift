...
public class AvailabilityGroupListLoadQueryRequest : ListQueryRequest {
     ...
     */
     ...
     public override func send(client: Optional<BaseClient> = nil, callback: @escaping (AvailabilityGroupListLoadQueryResponse?, Error?) -> ()) throws {
    ...
    /**
     ...
     - Note: Overrides
     */
    public override func createResponse(httpResponse: URLResponse, data : Data) throws -> AvailabilityGroupListLoadQueryResponse {

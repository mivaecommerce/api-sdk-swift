...
public class BranchJavaScriptResourceVersionListLoadQueryRequest : ListQueryRequest {
    ...
    /**
     ...
     - Parameters:
        - callback: The callback function with signature (BranchJavaScriptResourceVersionListLoadQueryResponse?, Error?).
     - Note: Overrides
     */

     public override func send(client: Optional<BaseClient> = nil, callback: @escaping (BranchJavaScriptResourceVersionListLoadQueryResponse?, Error?) -> ()) throws {
        if let client = client ?? self.client {
            client.send(self) { request, response, error in
                callback(response as? BranchJavaScriptResourceVersionListLoadQueryResponse, error)
            }
        } else {
    ...
    /**
     ...
     - Note: Overrides
     */
    public override func createResponse(httpResponse: URLResponse, data : Data) throws -> BranchJavaScriptResourceVersionListLoadQueryResponse {
        ...
        return try decoder.decode(BranchJavaScriptResourceVersionListLoadQueryResponse.self, from: data)
    }
    ...
    override public func getResponseType() -> Response.Type {
        return BranchJavaScriptResourceVersionListLoadQueryResponse.self
    }

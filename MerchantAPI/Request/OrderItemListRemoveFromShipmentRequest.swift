...
/**
 ...
 - SeeAlso: https://docs.miva.com/json-api/functions/orderitemlist_removefromshipment
 */
public class OrderItemListRemoveFromShipmentRequest : Request {
    ...
    /**
     ...
     - Parameters:
        - callback: The callback function with signature (OrderItemListRemoveFromShipmentResponse?, Error?).
     - Note: Overrides
     */

     public override func send(client: Optional<BaseClient> = nil, callback: @escaping (OrderItemListRemoveFromShipmentResponse?, Error?) -> ()) throws {
        if let client = client ?? self.client {
            client.send(self) { request, response, error in
                callback(response as? OrderItemListRemoveFromShipmentResponse, error)
            }
        } else {
    ...
    /**
     ...
     - Note: Overrides
     */
    public override func createResponse(httpResponse: URLResponse, data : Data) throws -> OrderItemListRemoveFromShipmentResponse {
        ...
        return try decoder.decode(OrderItemListRemoveFromShipmentResponse.self, from: data)
    }
    ...
    override public func getResponseType() -> Response.Type {
        return OrderItemListRemoveFromShipmentResponse.self
    }

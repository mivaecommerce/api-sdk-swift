...
public class SubscriptionAndOrderItemUpdateRequest : Request {
    ...
    var subscriptionId : Optional<Int> = nil
    ...
    /**
     ...
     - Parameters:
        - callback: The callback function with signature (SubscriptionAndOrderItemUpdateResponse?, Error?).
     - Note: Overrides
     */

     public override func send(client: Optional<BaseClient> = nil, callback: @escaping (SubscriptionAndOrderItemUpdateResponse?, Error?) -> ()) throws {
        if let client = client ?? self.client {
            client.send(self) { request, response, error in
                callback(response as? SubscriptionAndOrderItemUpdateResponse, error)
            }
        } else {
    ...
    /**
     ...
     - Note: Overrides
     */
    public override func createResponse(httpResponse: URLResponse, data : Data) throws -> SubscriptionAndOrderItemUpdateResponse {
        ...
        return try decoder.decode(SubscriptionAndOrderItemUpdateResponse.self, from: data)
    }
    ...
    override public func getResponseType() -> Response.Type {
        return SubscriptionAndOrderItemUpdateResponse.self
    }
    ...
    /**
     ...
     - Returns:  Optional<Int>
     */
    public func getSubscriptionId() -> Optional<Int> {
     ...
     */
    @discardableResult
    public func setSubscriptionId(_ value: Optional<Int>) -> Self {

...
public class AttributeLoadCodeRequest : Request {
    ...
    /**
     ...
     - Parameters:
        - callback: The callback function with signature (AttributeLoadCodeResponse?, Error?).
     - Note: Overrides
     */

     public override func send(client: Optional<BaseClient> = nil, callback: @escaping (AttributeLoadCodeResponse?, Error?) -> ()) throws {
        if let client = client ?? self.client {
            client.send(self) { request, response, error in
                callback(response as? AttributeLoadCodeResponse, error)
            }
        } else {
    ...
    /**
     ...
     - Note: Overrides
     */
    public override func createResponse(httpResponse: URLResponse, data : Data) throws -> AttributeLoadCodeResponse {
        ...
        return try decoder.decode(AttributeLoadCodeResponse.self, from: data)
    }
    ...
    override public func getResponseType() -> Response.Type {
        return AttributeLoadCodeResponse.self
    }

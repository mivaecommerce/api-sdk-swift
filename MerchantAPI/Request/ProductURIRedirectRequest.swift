...
/**
 ...
 - SeeAlso: https://docs.miva.com/json-api/functions/producturi_redirect
 */
public class ProductURIRedirectRequest : ListQueryRequest {
    ...
    /**
     ...
     - Parameters:
        - callback: The callback function with signature (ProductURIRedirectResponse?, Error?).
     - Note: Overrides
     */

     public override func send(client: Optional<BaseClient> = nil, callback: @escaping (ProductURIRedirectResponse?, Error?) -> ()) throws {
        if let client = client ?? self.client {
            client.send(self) { request, response, error in
                callback(response as? ProductURIRedirectResponse, error)
            }
        } else {
    ...
    /**
     ...
     - Note: Overrides
     */
    public override func createResponse(httpResponse: URLResponse, data : Data) throws -> ProductURIRedirectResponse {
        ...
        return try decoder.decode(ProductURIRedirectResponse.self, from: data)
    }
    ...
    override public func getResponseType() -> Response.Type {
        return ProductURIRedirectResponse.self
    }

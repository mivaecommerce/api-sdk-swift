...
/**
 ...
 - SeeAlso: https://docs.miva.com/json-api/functions/pricegroupcategorylist_load_query
 */
public class PriceGroupCategoryListLoadQueryRequest : ListQueryRequest {
    ...
    /**
     ...
     - Parameters:
        - callback: The callback function with signature (PriceGroupCategoryListLoadQueryResponse?, Error?).
     - Note: Overrides
     */

     public override func send(client: Optional<BaseClient> = nil, callback: @escaping (PriceGroupCategoryListLoadQueryResponse?, Error?) -> ()) throws {
        if let client = client ?? self.client {
            client.send(self) { request, response, error in
                callback(response as? PriceGroupCategoryListLoadQueryResponse, error)
            }
        } else {
    ...
    /**
     ...
     - Note: Overrides
     */
    public override func createResponse(httpResponse: URLResponse, data : Data) throws -> PriceGroupCategoryListLoadQueryResponse {
        ...
        return try decoder.decode(PriceGroupCategoryListLoadQueryResponse.self, from: data)
    }
    ...
    override public func getResponseType() -> Response.Type {
        return PriceGroupCategoryListLoadQueryResponse.self
    }

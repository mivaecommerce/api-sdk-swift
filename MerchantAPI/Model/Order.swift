...
public class Order : Model {
    ...
    public override func encode(to encoder: Encoder) throws {
        ...
        try container.encodeIfPresent(Decimal.roundForEncoding(value: self.totalShip, precision: 2), forKey: .totalShip)
        try container.encodeIfPresent(self.formattedTotalShip, forKey: .formattedTotalShip)
        try container.encodeIfPresent(Decimal.roundForEncoding(value: self.totalTax, precision: 2), forKey: .totalTax)

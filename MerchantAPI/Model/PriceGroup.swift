...
public class PriceGroup : Model {
    ...
    public override func encode(to encoder: Encoder) throws {
        ...
        try container.encodeIfPresent(Decimal.roundForEncoding(value: self.minimumSubtotal, precision: 2), forKey: .minimumSubtotal)
        try container.encodeIfPresent(Decimal.roundForEncoding(value: self.maximumSubtotal, precision: 2), forKey: .maximumSubtotal)
        ...
        try container.encodeIfPresent(Decimal.roundForEncoding(value: self.minimumWeight, precision: 2), forKey: .minimumWeight)
        try container.encodeIfPresent(Decimal.roundForEncoding(value: self.maximumWeight, precision: 2), forKey: .maximumWeight)
        try container.encodeIfPresent(Decimal.roundForEncoding(value: self.basketMinimumSubtotal, precision: 2), forKey: .basketMinimumSubtotal)
        try container.encodeIfPresent(Decimal.roundForEncoding(value: self.basketMaximumSubtotal, precision: 2), forKey: .basketMaximumSubtotal)
        ...
        try container.encodeIfPresent(Decimal.roundForEncoding(value: self.basketMinimumWeight, precision: 2), forKey: .basketMinimumWeight)
        try container.encodeIfPresent(Decimal.roundForEncoding(value: self.basketMaximumWeight, precision: 2), forKey: .basketMaximumWeight)

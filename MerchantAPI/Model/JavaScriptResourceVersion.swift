...
public class JavaScriptResourceVersion : Model {
    ...
    var linkedResources : [JavaScriptResource]
    ...
    /**
     JavaScriptResourceVersion Decodable Constructor.
    ...
    public required init(from decoder: Decoder) throws {
        ...
        self.linkedResources = try container.decodeIfPresent([JavaScriptResource].self, forKey: .linkedResources) ?? []
     ...
     */
    public func getLinkedResources() -> [JavaScriptResource] {

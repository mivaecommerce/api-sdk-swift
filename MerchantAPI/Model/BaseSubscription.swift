...
public class BaseSubscription : Model {
    ...
    /**
     BaseSubscription Decodable Constructor.
    ...
    public override func encode(to encoder: Encoder) throws {
        ...
        try container.encodeIfPresent(Decimal.roundForEncoding(value: self.shipping, precision: 2), forKey: .shipping)
        try container.encodeIfPresent(self.formattedShipping, forKey: .formattedShipping)
        try container.encodeIfPresent(Decimal.roundForEncoding(value: self.subtotal, precision: 2), forKey: .subtotal)

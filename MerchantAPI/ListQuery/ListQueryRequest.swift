 ...
 *
 * $Id: ListQueryRequest.swift 73951 2019-03-07 21:16:17Z gidriss $
 */
...
public class ListQueryRequest : Request {
    ...
    /**
     ...
     - Note: Overrides
     */
    override public func createResponse(data : Data) throws -> ListQueryResponse {
    ...
    /**
     ...
     - Note: Overrides
     */
    public override func send(client: Optional<Client> = nil, callback: @escaping (ListQueryResponse?, Error?) -> ()) throws {
        fatalError("Method must be overridden")
    }
}
